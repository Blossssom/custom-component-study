...
const ToggleContainer = styled.div`
  ...
  > .toggle-container {
    ...
    height: 24px;
    border-radius: 30px;
    background: ${(props) => props.children[0].props.className === "toggle-container toggle--checked" ? "#4900ce" : "#8b8b8b" };
  ...
  > .toggle-circle {
    ...
    left: ${(props) => props.children[1].props.className === "toggle-circle toggle--checked" ? "27px" : "1px" };
    transition: 0.3s;
  }
`;
